...
#'
#' A dataset containing Splash Mountain wait times.
#'
#' @format A data frame with 287,948 rows and 4 variables:
#' \describe{
...
#'   }
#' @source "splash_mountain.csv" Disney World Ride Wait Time Datasets, TouringPlans.com, August 2023,
