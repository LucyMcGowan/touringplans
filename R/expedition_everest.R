...
#'
#' A dataset containing Expedition Everest wait times.
#'
#' @format A data frame with 232,858 rows and 4 variables:
#' \describe{
...
#'   }
#' @source "expedition_everest.csv" Disney World Ride Wait Time Datasets, TouringPlans.com, September 2021,
