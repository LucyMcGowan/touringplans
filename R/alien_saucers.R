...
#'
#' A dataset containing Alien Swirling Saucers wait times.
#'
#' @format A data frame with 129,876 rows and 4 variables:
#' \describe{
...
#'   }
#' @source "alien_saucers.csv" Disney World Ride Wait Time Datasets, TouringPlans.com, August 2023,
