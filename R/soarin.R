#' Soarin' Wait Times
#'
#' A dataset containing Soarin' wait times.
#'
#' @format A data frame with 232,568 rows and 4 variables:
#' \describe{
...
#'   }
#' @source "soarin.csv" Disney World Ride Wait Time Datasets, TouringPlans.com, September 2021,
