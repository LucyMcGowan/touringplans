#' DINOSAUR Wait Times
#'
#' A dataset containing DINOSAUR wait times.
#'
#' @format A data frame with 213,381 rows and 4 variables:
#' \describe{
...
#'   }
#' @source "dinosaur.csv" Disney World Ride Wait Time Datasets, TouringPlans.com, September 2021,
